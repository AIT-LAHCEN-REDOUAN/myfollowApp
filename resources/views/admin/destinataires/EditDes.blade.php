...
@can('Gestion_Client')
    <h1 class="text-white text-center font-bold bg-gray-100 p-2 rounded" style="min-width: 100px!important;position: absolute;margin-top: 80px;margin-left: 30px;color:chartreuse">Clients / Modifier</h1>

    <br>
    <br>
    <br>
    <div class='flex flex-col overflow-x-auto overflow-y-auto p-8' style="margin-top: 80px!important">    <div class="md:grid md:grid-cols-3 md:gap-6">
      <div class="mt-5 md:mt-0 md:col-span-2">
        @foreach ($data as $item)
            <form enctype="multipart/form-data" action="{{route('destinataires.update',['destinataire'=>$item->id])}}" method="POST">
          @method("PUT")
          @csrf
            ...
            <div class="px-4 py-5 bg-white sm:p-6">
              <div class="grid grid-cols-2 gap-6">
                 <div class="col-span-2 sm:col-span-1"> <!-- col-span-2 for full width on small screens, col-span-1 for half width on larger screens -->
                  ...
                  <input  disabled value={{$item->id}} type="number" name="iddestinataire" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                </div>
                ...
                <div class="col-span-2 sm:col-span-1"> <!-- col-span-2 for full width on small screens, col-span-1 for half width on larger screens -->
                  ...
                  <input @required(true) value={{$item->name}} type="text" name="Nom" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                </div>

                <div class="col-span-2 sm:col-span-1">
                  <label class="block text-sm font-medium text-gray-700">Telephone</label>
                  <input @required(true) value={{$item->Telephone}} type="text" name="Telephone" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                </div>

                <div class="col-span-1 sm:col-span-1">
                  <button style="background-color:darkgreen ;"  type="submit" class="text-white font-bold py-2 px-4 rounded">
                    Submit
                  </button>
                </div>
              </div>
