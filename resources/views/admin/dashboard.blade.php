...
@endsection
@section('statistic')
<div  class="relative bg-green-200  pb-25 pt-12"></div>
      ...
      <div>
          ...
          <form action="/" method="GET" class="w-full pb-16 md:flex">
            ...
            <span class="z-10 h-full leading-snug font-normal text-center text-blueGray-300 absolute bg-transparent rounded text-base items-center justify-center w-8 pl-3 py-3">
              ...
              <div class="relative flex items-center w-full md:w-1/2 lg:w-1/3 p-3">
                  <button class="text-white font-bold py-2 px-4 rounded" style="background-color:chartreuse">Filtrer</button>
              </div>
          </form>
                        ...
                        <div class="flex flex-wrap">
                            ...
                            >
                                ...
                                <div class="flex w-full">
                                    <div class="flex flex-wrap">
                                        <div class="w-2/6"><h5
                                                class="text-blueGray-400 uppercase font-bold text-md"
                                            >
                                            Entre <span class="font-semibold text-md text-blueGray-700">
                       {{$total_operation_in_pending}}
                    </span>
                                            </h5></div>
                                        <div class="w-2/6 text-blueGray-400 uppercase font-bold text-md">&nbsp;|&nbsp;</div>
                                        <div class="w-2/6"><h5 class="text-blueGray-400 uppercase font-bold text-md"> Sortie :  <span class="font-semibold text-md text-blueGray-700">
                      {{$total_operation_out_pending}}
                    </span>
                                            </h5></div>
                                    </div>
                                </div>
                            ...
                            >
                                ...
                                <div class="flex w-full">
                                    ...
                                    <div class="w-2/6"><h5
                                        ...
                                        >
                                            Entre :  <span class="font-semibold text-md text-blueGray-700">
                      {{$total_operation_in_annulee}}
                    </span>
                                        </h5></div>
                                    <div class="w-2/6 text-blueGray-400 uppercase font-bold text-md">&nbsp;|&nbsp;</div>
                                    <div class="w-2/6"><h5 class="text-blueGray-400 uppercase font-bold text-md"> Sortie : <span class="font-semibold text-md text-blueGray-700">
                      {{$total_operation_out_annulee}}
                    </span>
                                        </h5></div>
                                </div>
                                </div>
...
<div class="container">
    <h2 class="text-center font-bold text-black text-xl mt-4 mb-3 p-3 "></h2>

</div>
<div class="container-fluid">
    <div class="flex flex-wrap">
        <div id="mouvementsChartContainer" class="chart-container pie-chart w-full lg:w-1/2 bg-white p-4 rounded">
        ...
        <div id="caChartContainer" class="chart-container pie-chart w-full lg:w-1/2 bg-white p-4 rounded">
...
<div class="container-fluid mt-4">
    <div class="flex flex-wrap">
        <div id="statutChartContainer" class="chart-container pie-chart w-full lg:w-1/2 bg-white p-4 rounded">
            <canvas id="statut_chart"></canvas>
            <h6 class="text-center text-blueGray-700 p-4 font-bold">Opérations In par statut</h6>
        </div>
        <div id="operationChartContainer" class="chart-container pie-chart w-full lg:w-1/2 bg-white p-4 rounded">
...
<script>
    ...
    $(function(){
        ...
        function makechart()
        {
            var mouvements=['Entre','Sortie','Retour'];
            ...
            var status=['Valider_Automatique','Corrigée','Dérogée',"Annuler",'En Cours'];
