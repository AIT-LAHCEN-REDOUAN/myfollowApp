...
@can('Gestion_DataBase')
    <h1 class="text-white text-center font-bold bg-gray-100 p-2 rounded" style="min-width: 100px!important;position: absolute;margin-top: 80px;margin-left: 30px;color:chartreuse">Produits</h1>
...
<div class='flex flex-col overflow-x-auto overflow-y-auto'>
    <table id="myTable" style="background-color: white!important " class='table-auto w-full rounded-lg'>
      <thead>
      <tr style="background-color: chartreuse ;" class=' text-center text-white font-light'>
      ...
      <tbody>
        ...
        <tr>
          <td class='px-4 py-2 text-center'>
            {!!DNS2D::getBarcodeHTML("$item->Reference","QRCODE",3,3)!!}
          </td>
      ...
      <td class=' py-2 text-center'>
        ...
        <form id="delete-form-{{ $item->Reference }}"  action="{{ route('colies.destroy', ['coly'=>$item->Reference])}}" method="POST">
          @csrf
          @method("DELETE")
          <button type="submit">
          ...
          @can('Gestion_DataBase')
                ...
                <a href="{{ route('colies.edit', ['coly'=>$item->Reference])}}">
      ...
      @endcan
            ...
            <a href="/generatepdf/{{$item->Reference}}">
            <svg xmlns="http://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><style>svg{fill:#184ecd}</style><path d="M128 0C92.7 0 64 28.7 64 64v96h64V64H354.7L384 93.3V160h64V93.3c0-17-6.7-33.3-18.7-45.3L400 18.7C388 6.7 371.7 0 354.7 0H128zM384 352v32 64H128V384 368 352H384zm64 32h32c17.7 0 32-14.3 32-32V256c0-35.3-28.7-64-64-64H64c-35.3 0-64 28.7-64 64v96c0 17.7 14.3 32 32 32H64v64c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V384zM432 248a24 24 0 1 1 0 48 24 24 0 1 1 0-48z"/></svg>
        </a>
            </div>
    </div>
      </td>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        deleteForms.forEach(form => {
            form.addEventListener('submit', function(e) {
                ...
                Swal.fire({
                    title: 'Vous étes sur ?',
                    text: 'Vous voulez vraiment supprimer ce colie !',
                    icon: 'warning',
