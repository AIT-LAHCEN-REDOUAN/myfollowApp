...
@can('Gestion_Suivi_tracabilites')
    <h1 class="text-white text-center font-bold bg-gray-100 p-2 rounded" style="min-width: 100px!important;position: absolute;margin-top: 80px;margin-left: 30px;color:chartreuse">Traçabilité</h1>
...
<br>
        ...
        <div class='flex flex-col overflow-x-auto overflow-y-auto'>
            <table id="myTable" style="background-color: white!important; border-radius:20px" class='table-auto w-full'>
                <thead>
                <tr style="background-color:chartreuse" class='w-100  text-white font-light'>
