...
@can('Gestion_Suivi_tracabilites')
    <h1 class="text-white text-center font-bold bg-gray-100 p-2 rounded" style="min-width: 100px!important;position: absolute;margin-top: 80px;margin-left: 30px;color:chartreuse">Traçabilité / Out</h1>
                    ...
                    <td class='px-4 py-2 text-center whitespace-nowrap'>
                        <div class="flex">
                            @can('supprimer_operations')
                                <div class="w-1/2">
                                    <form id="delete-form-{{ $item->id }}" action="{{route('delete_NonValider',['id'=>$item->id])}}" method="POST">
                                        @csrf
                                        @method("DELETE")
                                        <button type="submit">
                                            <!-- Your delete icon or button goes here -->
                                        </button>
                                    </form>
                                </div>
                            @endcan
{{--                            <!-- Uncomment this section if you have an edit action -->--}}
{{--                            <!-- @can('modifier_operations')--}}
{{--                                <div class="w-1/2">--}}
{{--                                    <a href="{{route("edit_op",["id_op"=>$item->id])}}">--}}
{{--                                <!-- Your edit icon or link goes here -->--}}
{{--                                </a>--}}
{{--                        </div>--}}
{{--                        @endcan --}}
    </div>
