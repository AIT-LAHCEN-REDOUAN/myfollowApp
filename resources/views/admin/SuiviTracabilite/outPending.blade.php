...
@can('Gestion_Suivi_tracabilites')
        <h1 class="text-white text-center font-bold bg-gray-100 p-2 rounded" style="min-width: 100px!important;position: absolute;margin-top: 80px;margin-left: 30px;color:chartreuse">Traçabilité / Out / En cours</h1>
        ...
        <div class='flex flex-col overflow-x-auto overflow-y-auto p-8' style="margin-top: 80px!important">
            <table id="myTable" style="background-color: white!important; border-radius:20px" class='table-auto w-full'>
                ...
                <tr style="background-color: chartreuse" class=' text-white font-light'>
                    ...
                    <th class='px-4 py-2 text-center whitespace-nowrap'>Quantite Demandée</th>
                ...
                @foreach ($Suivi_de_tracabilite as $item)
                    <tr>
                        ...
                        <td class='px-4 py-2 text-center whitespace-nowrap'>{{$item->Quantite_sortie ?? "---"}}</td>
