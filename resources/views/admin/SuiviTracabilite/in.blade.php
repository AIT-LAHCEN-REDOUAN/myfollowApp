...
@can('Gestion_Suivi_tracabilites')
    <h1 class="text-white text-center font-bold bg-gray-100 p-2 rounded" style="min-width: 100px!important;position: absolute;margin-top: 80px;margin-left: 30px;color:chartreuse">Traçabilité / In</h1>
    ...
    <div class='flex flex-col overflow-x-auto overflow-y-auto p-8' style="margin-top: 80px!important">
      ...
      <thead>
      <tr style="background-color: chartreuse ; border-radius:20px" class=' text-white font-light'>
...
{{--            @can('supprimer_operations_in')--}}
{{--<form action="{{route('delete_in',['etat'=>$item->etat])}}" method="POST">--}}
{{--          @csrf--}}
{{--          @method("DELETE")--}}
{{--          <button type="submit">--}}
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        deleteForms.forEach(form => {
            form.addEventListener('submit', function(e) {
                ...
                Swal.fire({
                    title: 'Vous étes sur ?',
                    text: 'Vous voulez vraiment supprimer cette opération !',
                    icon: 'warning',
