...
@can('Gestion_Suivi_tracabilites')
    <h1 class="text-white text-center font-bold bg-gray-100 p-2 rounded" style="min-width: 100px!important;position: absolute;margin-top: 80px;margin-left: 30px;color:chartreuse">Traçabilité / Non validée</h1>
