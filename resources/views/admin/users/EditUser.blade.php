...
@section('data')
    ...
    />
    @can('Gestion_User')
    <h1 class="text-white text-center font-bold bg-gray-100 p-2 rounded" style="min-width: 100px!important;position: absolute;margin-top: 80px;margin-left: 30px;color:chartreuse">Utilisateur / Modifier</h1>
...
{{--      @foreach ($data as $item)--}}
           <div style="border-radius: 20px" class="mt-5 md:mt-0 md:col-span-2">
              ...
              <div class="grid grid-cols-2 gap-6">
                ...
                <div class="col-span-2 sm:col-span-1">
                  ...
                  <div class="col-span-2 sm:col-span-1">
                    ...
                    <input @required(true) value={{$item->Image}} type="file" name="Photo" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                  </div>
