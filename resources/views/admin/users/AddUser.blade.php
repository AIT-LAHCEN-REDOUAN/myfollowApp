...
@section('data')
    <h1 class="text-white text-center font-bold bg-gray-100 p-2 rounded" style="min-width: 100px!important;position: absolute;margin-top: 80px;margin-left: 30px;color:chartreuse">Utilisateur / Ajouter</h1>
                            ...
                            <div class="col-span-2 sm:col-span-1">
                                ...
                                >
                                    <select @required(true)  name="permissions[]" multiple=""
                                        ...
                                        <option value="{{$item->id}}"> <span> {{$item->id}}      </span> {{$item->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
  ...
  onDelete: function (values) {
    ...
    return true;
                            ...
                            <div class="col-span-1 sm:col-span-1">
                                ...
                                <button style="background-color:darkgreen; position: relative; top: 10px" type="submit"
