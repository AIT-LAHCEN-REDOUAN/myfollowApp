...
@can('afficher_input_database')
    <h1 class="text-white text-center font-bold bg-gray-100 p-2 rounded" style="min-width: 100px!important;position: absolute;margin-top: 80px;margin-left: 30px;color:darkred">Produits</h1>
...
<div class='flex flex-col overflow-x-auto overflow-y-auto'>
    <table id="myTable" style="background-color: white!important;" class='table-auto w-full '>
      <thead>
      <tr class='bg-red-600 text-center text-white font-light'>
