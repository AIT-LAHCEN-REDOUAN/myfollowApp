...
class SuiviTracabilite extends Controller
{
    ...
    public function edit_operations($id_op){
        ...
        return view("admin.SuiviTracabilite.edit",["operations"=>$get_op,"total_colie"=>$get_total_colie,"total_fournisseur"=>$get_total_fournisseur,"total_destinataire"=>$get_total_destinataire,"total_in"=>$total_produit_in,"total_out"=>$total_produit_out,"total_retour"=>$total_produit_retour,"total_operation"=>$total_operation]);
