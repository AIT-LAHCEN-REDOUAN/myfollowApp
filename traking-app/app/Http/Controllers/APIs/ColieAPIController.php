...
public function get_stock() {
    $get_stock_info = Stock::all();
    $data = [];

    foreach ($get_stock_info as $stock) {
        $data[] = [
            "Reference_colie" => $stock->Reference_colie,
            "Designation" => $stock->colie->Designation,
            "Quantite_Disponible" => $stock->Quantite_Disponible,
            "Chiffre_d'affaire" => $stock->chiffre_daffaire
        ];
    }
