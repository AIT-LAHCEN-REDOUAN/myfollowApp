...
@can('afficher_operations_in')
    <h1 class="text-white text-center font-bold bg-gray-100 p-2 rounded" style="min-width: 100px!important;position: absolute;margin-top: 80px;margin-left: 30px;color:darkred">Traçabilité / Out / En cours</h1>
    ...
    <div class='flex flex-col overflow-x-auto overflow-y-auto p-8' style="margin-top: 80px!important">
        <table id="myTable" style="background-color: white!important;" class='table-auto w-full'>
            ...
            <tr class='bg-red-600 text-white font-light'>
                ...
                <th class='px-4 py-2 text-center whitespace-nowrap'>Quantite Avant Traitement</th>
                <th class='px-4 py-2 text-center whitespace-nowrap'>Quantite Apres Traitement</th>
                ...
                <th class='px-4 py-2 text-center whitespace-nowrap'>Date De Traitement</th>
                <th class="class='px-4 py-2 text-center whitespace-nowrap" colspan="2" >Action</th>
            ...
            @foreach ($Suivi_de_tracabilite as $item)
                <tr>
                    ...
                    <td class='px-4 py-2 text-center whitespace-nowrap'>{{$item->Quantite_avant_traitement ?? "---"}}</td>
                    <td class='px-4 py-2 text-center whitespace-nowrap'>{{$item->Quantite_apres_traitement ?? "---"}}</td>
                    <td class='px-4 py-2 text-center whitespace-nowrap'>{{$item->statut ?? "---"}}</td>
                    <td class='px-4 py-2 text-center whitespace-nowrap'>{{$item->motif ?? "---"}}</td>
                    <td class='px-4 py-2 text-center whitespace-nowrap'>{{$item->etat ?? "---"}}</td>
                    <td class='px-4 py-2 text-center whitespace-nowrap'>{{$item->updated_at ?? "---"}}</td>
                    <td class='px-4 py-2 text-center whitespace-nowrap'>
                        @if($item->statut=="Pending")
                            <div class="flex">
                                <div class="w-1/2">
                                    <a href="{{route("edit_op",["id_op"=>$item->id])}}" >
                                        <svg xmlns="http://www.w3.org/2000/svg" height="18" width="18" viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><style>svg{fill:#184ecd}</style><path d="M471.6 21.7c-21.9-21.9-57.3-21.9-79.2 0L362.3 51.7l97.9 97.9 30.1-30.1c21.9-21.9 21.9-57.3 0-79.2L471.6 21.7zm-299.2 220c-6.1 6.1-10.8 13.6-13.5 21.9l-29.6 88.8c-2.9 8.6-.6 18.1 5.8 24.6s15.9 8.7 24.6 5.8l88.8-29.6c8.2-2.7 15.7-7.4 21.9-13.5L437.7 172.3 339.7 74.3 172.4 241.7zM96 64C43 64 0 107 0 160V416c0 53 43 96 96 96H352c53 0 96-43 96-96V320c0-17.7-14.3-32-32-32s-32 14.3-32 32v96c0 17.7-14.3 32-32 32H96c-17.7 0-32-14.3-32-32V160c0-17.7 14.3-32 32-32h96c17.7 0 32-14.3 32-32s-14.3-32-32-32H96z"/></svg>
                                    </a>
                                </div>
                                <div class="w-1/2">
                                    <form id="delete-form-{{ $item->id }}" action="{{route('delete_in',['id'=>$item->id])}}" method="POST">
                                        @csrf
                                        @method("DELETE")
                                        <button type="submit">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><style>svg{fill:#d11566}</style><path d="M135.2 17.7L128 32H32C14.3 32 0 46.3 0 64S14.3 96 32 96H416c17.7 0 32-14.3 32-32s-14.3-32-32-32H320l-7.2-14.3C307.4 6.8 296.3 0 284.2 0H163.8c-12.1 0-23.2 6.8-28.6 17.7zM416 128H32L53.2 467c1.6 25.3 22.6 45 47.9 45H346.9c25.3 0 46.3-19.7 47.9-45L416 128z"/></svg>
                                        </button>
                                    </form>
                                </div>
                            </div>
