...
@can('afficher_operations_in')
    <h1 class="text-white text-center font-bold bg-gray-100 p-2 rounded" style="min-width: 100px!important;position: absolute;margin-top: 80px;margin-left: 30px;color:darkred">Traçabilité / Out / Annulée</h1>
    ...
    <div class='flex flex-col overflow-x-auto overflow-y-auto p-8' style="margin-top: 80px!important">
        <table id="myTable" style="background-color: white!important;" class='table-auto w-full'>
            ...
            <tr class='bg-red-600 text-white font-light'>
                ...
                <th class='px-4 py-2 text-center whitespace-nowrap'>Date Annulation</th>
            </tr>
            </thead>
            <tbody>
