...
@can('afficher_operations_retour')
    <h1 class="text-white text-center font-bold bg-gray-100 p-2 rounded" style="min-width: 100px!important;position: absolute;margin-top: 80px;margin-left: 30px;color:darkred">Traçabilité / Retour</h1>
        ...
        <table id="myTable" style="background-color: white!important;" class='table-auto w-full '>
            ...
            @foreach ($Suivi_de_tracabilite as $item)
                <tr>
                    ...
                    <td class='px-4 py-2 text-center whitespace-nowrap'>{{$item->Quantite_Retour ?? "---" }}</td>
