...
@can('ajouter_fournisseur')
    <h1 class="text-white text-center font-bold bg-gray-100 p-2 rounded" style="min-width: 100px!important;position: absolute;margin-top: 80px;margin-left: 30px;color:darkred">Fournisseurs / Ajouter</h1>
...
{{--<br>--}}
{{--<br>--}}
{{--    <div class="flex" id="succes_message" style="background-color: rgb(18, 210, 18); color: #fff; padding: 10px; border-radius: 5px; text-align: center;">--}}
...
{{--        // Use JavaScript to hide the error message after 5 seconds--}}
{{--        setTimeout(function() {--}}
{{--            var successMessage = document.getElementById('succes_message');--}}
{{--            if (successMessage) {--}}
...
{{--    @endif--}}
        @if (session('success'))
            <div class="alert">
                L'utilisateur a été bien ajouter !
                <span class="closebtn text-xl " onclick="this.parentElement.style.display='none';">&times;</span>
            </div>
        @endif
      <br>
        <form class="mb-5" enctype="multipart/form-data" action="{{route('fournisseur_import')}}" method="post">
          @csrf
          <input @required(true) type="file" name="file" accept=".xlsx , .csv" >
          <button style="background-color: #de581e ; " type="submit" class="text-white font-bold py-2 px-4 rounded">Import</button>
        </form>
            ...
            <div class="px-4 py-5 bg-white sm:p-6">
              <div class="grid grid-cols-2 gap-6">
                <div class="col-span-2 sm:col-span-1">
                  ...
                  <input @required(true)  type="email" name="email" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"/>
                </div>
                <div class="col-span-2 sm:col-span-1"> <!-- col-span-2 for full width on small screens, col-span-1 for half width on larger screens -->
                  ...
                  <input @required(true) type="text" name="Nom" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                </div>
                <div class="col-span-2 sm:col-span-1">
                  <label class="block text-sm font-medium text-gray-700">Telephone</label>
                  <input @required(true) type="text" name="Telephone" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                </div>
