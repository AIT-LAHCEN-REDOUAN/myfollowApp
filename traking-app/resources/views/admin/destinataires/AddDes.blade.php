...
@can('ajouter_client')
    <h1 class="text-white text-center font-bold bg-gray-100 p-2 rounded" style="min-width: 100px!important;position: absolute;margin-top: 80px;margin-left: 30px;color:darkred">Clients / Ajouter</h1>
...
<div class='flex flex-col overflow-x-auto overflow-y-auto p-8' style="margin-top: 40px!important">
    <div class="md:grid md:grid-cols-3 md:gap-6">
      <br>
        <form class="mb-5" enctype="multipart/form-data" action="{{route('destinataire_import')}}" method="post">
          @csrf
      ...
      <div class="mt-5 md:mt-0 md:col-span-2">
            <form enctype="multipart/form-data" action="{{route('destinataires.store')}}" method="POST">
          @csrf
            ...
            <div class="px-4 py-5 bg-white sm:p-6">
              <div class="grid grid-cols-2 gap-6">
                ...
                <div class="col-span-2 sm:col-span-1"> <!-- col-span-2 for full width on small screens, col-span-1 for half width on larger screens -->
                  ...
                  <input @required(true)  type="text" name="name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                </div>
                <div class="col-span-2 sm:col-span-1">
