...
@section('data')
    <h1 class="text-white text-center font-bold bg-gray-100 p-2 rounded" style="min-width: 100px!important;position: absolute;margin-top: 80px;margin-left: 30px;color:darkred">Utilisateur / Ajouter</h1>
  ...
  onDelete: function (values) {
    ...
    return true;
                            ...
                            <div class="col-span-1 sm:col-span-1">
                                ...
                                <button style="background-color: #de581e; position: relative; top: 10px" type="submit"
